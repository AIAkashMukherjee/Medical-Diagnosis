...
# st.title("👨‍⚕️ GenAI-Powered Medical Diagnosis")
# st.markdown(
#     "This application uses a FastAPI backend with a LangChain/GenAI stack to help patients get a diagnosis from their reports and allow doctors to access their patients' diagnosis history."
# )
...
#         with st.form("upload_form"):
#             uploaded_files = st.file_uploader(
#                 "Choose medical report files (PDF, TXT)",
#                 type=["pdf", "txt"],
#                 accept_multiple_files=True
#             )
#             upload_submitted = st.form_submit_button("Upload Reports")
